    ...
    return (
        <section className="uploadSection">
            <div className='descriptionSection'>
                ...
                <div className="descriptionBtn"><label for="upload">上傳文件</label><input onChange={handleUploadPdf} style={{'opacity':0}} type="file" id="upload" name="upload" accept=".jpg, .jpeg, .png, .pdf"/></div>
            </div>
